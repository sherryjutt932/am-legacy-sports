...
//   // --- 🔸 Circular mask starting from center ---
//   float distFromCenter = distance(vUv, vec2(0.5));
//   float radius = mix(0.0, 0.707, progress); // 0.707 ≈ max distance in UV from center to corner
//   float softness = w * 0.5; // controls feather/smoothness

//   // circular reveal with noise
//   float mask = smoothstep(radius, radius - softness, distFromCenter + realnoise * 0.05);
